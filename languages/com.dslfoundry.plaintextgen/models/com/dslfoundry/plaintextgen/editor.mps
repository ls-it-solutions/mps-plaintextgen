...
<model ref="r:24b3048c-1397-4aa3-93e4-09ca4438cddf(com.dslfoundry.plaintextgen.editor)">
  ...
  <node concept="24kQdi" id="Z$zlZaZkBc">
    ...
    <node concept="3EZMnI" id="6gwxh6GcxZe" role="6VMZX">
  ...
  <node concept="24kQdi" id="Z$zlZaZkOW">
    ...
    <node concept="3EZMnI" id="Z$zlZaZkP3" role="2wV5jI">
      <node concept="3EZMnI" id="Z$zlZaZkPa" role="3EZMnx">
        ...
        <node concept="3F0ifn" id="Tjjttnj8gZ" role="3EZMnx" />
        <node concept="2iRfu4" id="Z$zlZaZkPf" role="2iSdaV" />
        <node concept="3F0ifn" id="Tjjttnj8hh" role="3EZMnx">
          <property role="3F0ifm" value="encoding:" />
        </node>
        <node concept="3F0A7n" id="Tjjttnj8h_" role="3EZMnx">
          <property role="1$x2rV" value="UTF-8" />
          <property role="1O74Pk" value="true" />
          <ref role="1NtTu8" to="myiq:Tjjttnj8gy" resolve="encoding" />
          <node concept="OXEIz" id="Tjjttnj8hK" role="P5bDN">
            <node concept="1oHujT" id="Tjjttnj8hM" role="OY2wv">
              <property role="1oHujS" value="&lt;standard UTF-8&gt;" />
              <node concept="1oIgkG" id="Tjjttnj8hN" role="1oHujR">
                <node concept="3clFbS" id="Tjjttnj8hO" role="2VODD2">
                  <node concept="3clFbF" id="TjjttnjeLr" role="3cqZAp">
                    <node concept="37vLTI" id="Tjjttnjfxo" role="3clFbG">
                      <node concept="10Nm6u" id="TjjttnjfzU" role="37vLTx" />
                      <node concept="2OqwBi" id="TjjttnjeT9" role="37vLTJ">
                        <node concept="3GMtW1" id="TjjttnjeLq" role="2Oq$k0" />
                        <node concept="3TrcHB" id="Tjjttnjf3P" role="2OqNvi">
            ...
            <node concept="1ou48o" id="TjjttnjfJr" role="OY2wv">
              <node concept="3GJtP1" id="TjjttnjfJt" role="1ou48n">
                <node concept="3clFbS" id="TjjttnjfJv" role="2VODD2">
                  <node concept="3clFbF" id="TjjttnjgiR" role="3cqZAp">
                    <node concept="2OqwBi" id="TjjttnjrIj" role="3clFbG">
                      <node concept="2OqwBi" id="TjjttnjpCl" role="2Oq$k0">
                        <node concept="2OqwBi" id="Tjjttnjn4X" role="2Oq$k0">
                          <node concept="2YIFZM" id="Tjjttnjmm6" role="2Oq$k0">
                            <ref role="37wK5l" to="7x5y:~Charset.availableCharsets():java.util.SortedMap" resolve="availableCharsets" />
                            <ref role="1Pybhc" to="7x5y:~Charset" resolve="Charset" />
                          </node>
                          <node concept="liA8E" id="TjjttnjoHl" role="2OqNvi">
                            <ref role="37wK5l" to="33ny:~SortedMap.keySet():java.util.Set" resolve="keySet" />
                          </node>
                        </node>
                        <node concept="liA8E" id="TjjttnjqYD" role="2OqNvi">
                          <ref role="37wK5l" to="33ny:~Collection.stream():java.util.stream.Stream" resolve="stream" />
                        </node>
                      </node>
                      <node concept="liA8E" id="Tjjttnjtbw" role="2OqNvi">
                        <ref role="37wK5l" to="1ctc:~Stream.collect(java.util.stream.Collector):java.lang.Object" resolve="collect" />
                        <node concept="2YIFZM" id="TjjttnjveP" role="37wK5m">
                          <ref role="37wK5l" to="1ctc:~Collectors.toList():java.util.stream.Collector" resolve="toList" />
                          <ref role="1Pybhc" to="1ctc:~Collectors" resolve="Collectors" />
                          <node concept="17QB3L" id="Tjjttnjx2G" role="3PaCim" />
                        </node>
                      </node>
                    </node>
                  </node>
              ...
              <node concept="1ouSdP" id="TjjttnjfJx" role="1ou48m">
                <node concept="3clFbS" id="TjjttnjfJz" role="2VODD2">
                  <node concept="3clFbF" id="TjjttnjxXM" role="3cqZAp">
                    <node concept="37vLTI" id="TjjttnjyYj" role="3clFbG">
                      <node concept="3GLrbK" id="Tjjttnjz7k" role="37vLTx" />
                      <node concept="2OqwBi" id="Tjjttnjy5w" role="37vLTJ">
                        <node concept="3GMtW1" id="TjjttnjxXL" role="2Oq$k0" />
                        <node concept="3TrcHB" id="Tjjttnjyqo" role="2OqNvi">
                          <ref role="3TsBF5" to="myiq:Tjjttnj8gy" resolve="encoding" />
                        </node>
                      </node>
                    </node>
              ...
              <node concept="17QB3L" id="Tjjttnjg2$" role="1eyP2E" />
            </node>
          </node>
        </node>
      </node>
            ...
            <node concept="3clFbS" id="2jBmyzyAS43" role="2VODD2">
              ...
              <node concept="3clFbJ" id="2jBmyzyAS5p" role="3cqZAp">
                <node concept="2OqwBi" id="2jBmyzyASuJ" role="3clFbw">
                  ...
                  <node concept="3t7uKx" id="2jBmyzyASAB" role="2OqNvi">
                    <node concept="uoxfO" id="2jBmyzyASAD" role="3t7uKA">
                ...
                <node concept="3eNFk2" id="2jBmyzyB1VG" role="3eNLev">
                  <node concept="2OqwBi" id="2jBmyzyB2xN" role="3eO9$A">
                    ...
                    <node concept="3t7uKx" id="2jBmyzyB2H3" role="2OqNvi">
                      <node concept="uoxfO" id="2jBmyzyB2H5" role="3t7uKA">
